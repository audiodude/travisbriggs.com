---
title: Getting Reverted on Wikipedia
...
The reasons may vary, but someone might have left a single cryptic message on the revert edit, like [WP:NOTE](https://en.wikipedia.org/wiki/Wikipedia:Notability). They reference some arcane policy (_okay, notability is not arcane but you get the picture_) and are never heard from again.

I recently made the most [WP:BOLD](https://en.wikipedia.org/wiki/Wikipedia:Be_bold) set of edits on Wikipedia that I had ever made:

![List of Wikipedia edits on baseball topics](/assets/img/garden/image.png)
_List of baseball edits. Spoiler: most of them got reverted_

Almost all of them got reverted.
